...
export default function Index() {
  ...
  const handleExtismScrapeWebsite = async () => {
    try {
        ...
        <div className="flex flex-col items-center gap-16">
          ...
          <div className="w-full max-w-2xl">
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 border border-gray-200 dark:border-gray-700">
              ...
              <div className="space-y-4">
                <div>
                  <label htmlFor="extism-url" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    URL
                  </label>
                  <input
                    id="extism-url"
                ...
                <button
                  onClick={handleExtismScrapeWebsite}
                  disabled={!extismReady || scrapeLoading}
                ...
                {scrapeResult && !scrapeError && (
                  <div className="p-4 bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800 rounded-lg">
                    <div className="text-center">
                      <div className="text-sm text-purple-700 dark:text-purple-300 mb-1">Scraped Content</div>
                      <div className="text-sm text-purple-800 dark:text-purple-200 max-h-32 overflow-y-auto">
                        {scrapeResult}
                      </div>
                    </div>
                  </div>
                ...
                {scrapeError && (
                  <div className="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                    <div className="text-center">
                      ...
                      <div className="text-sm text-red-800 dark:text-red-200">{scrapeError}</div>
                    </div>
                  </div>
                )}
              </div>
